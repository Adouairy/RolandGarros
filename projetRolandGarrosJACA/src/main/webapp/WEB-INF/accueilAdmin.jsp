	...
	<div class="row content">
		...
		<div class="col-sm-8 text-left">
			...
			<fieldset id="infoCompl">
				...
				<form method="get" action="compteRenduEnvoyer">

					<p>Sélectionner votre aidé :</p>
					<select name="aideSelect" value="${aide.nom}" required />
					<c:forEach items="${ListeAidesDuConnecte}" var="ListeAidesDuConnecteValue"
						varStatus="status">
						<option value="${ListeAidesDuConnecteValue.id}">
							${ListeAidesDuConnecteValue.nom} ${ListeAidesDuConnecteValue.prenom}</option>
					</c:forEach>
					</select><br />
